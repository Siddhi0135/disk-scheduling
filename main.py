from tkinter import * #importing all functions from tkinter module for creating gui
import turtle #turtle graphic library to draw graphics
import pandas as pd #library for data manipulation and analysis
import matplotlib.pyplot as plt # library for creating plots and visualisation
...
def graphy(request_arr, start): #creates bar graph showing the total head movement for each dsa
    plot_list=[]
...
def Visualise(option, request_arr, start):
    ...
    if option == "FCFS":                        # Select and run algorithm
        Order, Sum = FCFS(request, start)       # visualise the dsa using turtle graphics
    elif option =="SSTF":
    ...
    Disk.exitonclick()
#------------------------------------------------------------------------------
def Main(): #create the main gui using tkinter
    # create labels, dropdowns, buttons for selecting algorithm
